...
The [paper](https://github.com/gmenchetti/Sales-Prediction/blob/master/docs/Paper.pdf) and the [presentation](https://github.com/gmenchetti/Sales-Prediction/blob/master/docs/Slides.pdf) give more details about the problem and the data.
